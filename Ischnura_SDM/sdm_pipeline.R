getwd()
setwd("C:/Users/r01zb21/OneDrive - University of Aberdeen/01_PhD Documents/02_Modelling code/CHAPTER 2_Species Distribution Model")
...
# Bias map
bias_map_2 <- rast("Data/Presence_generated/bias_map/bias_map_2.grd")
